 ...
 * @author Rayhan
 */
public class FormOrders extends JFrame {
    ...
    private String[] header
            = {"Nomor", "Nama Customer", "Total Jumlah", "Total Berat", "Total Harga", "Tanggal Pesan", "Status"};

    /**
     * Creates new form FormOrders
     */
    public FormOrders() {
        initComponents();
        open_db();
        ...
        subTitleLabel.setText("Admin/Order");
        ...
        tblOrders.getTableHeader().setBackground(ivory);
    }
    ...
    private void baca_data() {
        try {
            ...
            while (rs.next()) {
                ...
                dataTable[x][1] = rs.getString("nama_user");
                dataTable[x][2] = rs.getString("total_jumlah");
                dataTable[x][3] = rs.getString("total_berat") + " gram";
                dataTable[x][4] = "Rp" + rs.getString("total_harga");
                dataTable[x][5] = rs.getString("tanggal_pesan");
                dataTable[x][6] = rs.getString("status");
                x++;
            }
            tblOrders.setModel(new DefaultTableModel(dataTable, header));
    ...
    private void set_id() {
        ...
        current_id = (String) tblOrders.getValueAt(row, 0);
//        System.out.println(current_id);
    ...
    private void initComponents() {
        ...
        tblOrders.setGridColor(new java.awt.Color(204, 204, 204));
        tblOrders.setRowHeight(25);
        tblOrders.setShowHorizontalLines(true);
        tblOrders.setShowVerticalLines(true);
        tblOrders.getTableHeader().setResizingAllowed(false);
        ...
        btnUpdate.setIcon(new javax.swing.ImageIcon("D:\\Kuliah\\Kuliah\\Semester 4\\UAS\\ProyekAkhirUAS\\src\\icon\\Search.png")); // NOI18N
        btnUpdate.setText("Lihat Detail Order");
        ...
        bg.add(btnCetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 240, 90, 30));
        bg.add(jDateEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(738, 240, 140, 30));
        bg.add(jDateStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, 140, 30));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (current_id.equals("")) {
            JOptionPane.showMessageDialog(null, "Mohon pilih data order yang ingin ditampilkan");
        } else {
            FormOrderDetail orderDetail = new FormOrderDetail(current_id);
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        if (jDateStart.getDate() == null || jDateEnd.getDate() == null) {
            JOptionPane.showMessageDialog(null, "Mohon tanggal awal dan akhir pada laporan yang ingin ditampilkan");
        } else {
            try {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
                String dateStart = sdf.format(jDateStart.getDate());
                String dateEnd = sdf.format(jDateEnd.getDate());
                String reportPath = "D:\\Kuliah\\Kuliah\\Semester 4\\UAS\\ProyekAkhirUAS\\src\\main\\java\\com\\rayhanashlikh\\proyekakhiruas\\Report\\OrdersReport.jrxml";
