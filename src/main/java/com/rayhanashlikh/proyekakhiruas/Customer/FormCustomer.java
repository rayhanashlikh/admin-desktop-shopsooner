...
public class FormCustomer extends JFrame {
    ...
    private String[] header
            = {"Nomor", "Nama", "Username", "Nomor Telepon"};
    ...
    public FormCustomer() {
        ...
        subTitleLabel.setText("Admin/Customer");
        ...
        tblCustomer.getTableHeader().setBackground(ivory);
    }
    ...
    private void baca_data() {
        try {
            ...
            rsCustomer = stm.executeQuery("SELECT * FROM users;");
            ResultSetMetaData meta = rsCustomer.getMetaData();
            int col = meta.getColumnCount();
            int baris = 0;
            while (rsCustomer.next()) {
                baris = rsCustomer.getRow();
            }
            ...
            while (rsCustomer.next()) {
                dataTable[x][0] = rsCustomer.getString("id");
                dataTable[x][1] = rsCustomer.getString("nama");
                dataTable[x][2] = rsCustomer.getString("username");
                dataTable[x][3] = rsCustomer.getString("no_telp");
                n++;
                x++;
            }
            tblCustomer.setModel(new DefaultTableModel(dataTable, header));
    ...
    private void set_id() {
        ...
        current_id = (String) tblCustomer.getValueAt(row, 0);
//        System.out.println(current_id);
    ...
    private void initComponents() {
        ...
        tblCustomer.setGridColor(new java.awt.Color(204, 204, 204));
        ...
        btnHapus.setText("Hapus Customer");
        ...
        bg.add(btnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 240, -1, 30));
        ...
        bg.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 240, -1, 30));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        if (current_id.equals("")) {
            ...
            try {
                String sql = "DELETE FROM users WHERE id='" + current_id + "'";
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (current_id.equals("")) {
            ...
            UpdateCustomer customer = new UpdateCustomer(current_id);
            customer.setVisible(true);
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            String reportPath = "D:\\Kuliah\\Kuliah\\Semester 4\\UAS\\ProyekAkhirUAS\\src\\main\\java\\com\\rayhanashlikh\\proyekakhiruas\\Report\\CustomerReport.jrxml";
