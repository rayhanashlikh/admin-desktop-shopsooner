...
public class FormProducts extends JFrame {
    ...
    private String[] header
            = {"Nomor", "Penjual", "Nama", "Harga", "Satuan", "Stok", "Berat", "Gambar"};
    ...
    public FormProducts() {
        ...
        subTitleLabel.setText("Admin/Product");
        ...
        tblProducts.setOpaque(true);
        tblProducts.setFillsViewportHeight(true);
        tblProducts.setBackground(ivory);
        tblProducts.getTableHeader().setBackground(ivory);
    }
    ...
    private void baca_data() {
        try {
            ...
            while (rs.next()) {
                ...
                dataTable[x][1] = rs.getString("nama_seller");
                dataTable[x][2] = rs.getString("nama");
                dataTable[x][3] = "Rp" + rs.getString("harga");
                dataTable[x][4] = rs.getString("satuan");
                dataTable[x][5] = rs.getString("jumlah");
                dataTable[x][6] = rs.getString("berat") + " gram";
                String gambar = rs.getString("gambar");
                ImageIcon icon = new ImageIcon("D:\\Kuliah\\Kuliah\\Semester 4\\Tugas\\BATIKRAFT\\batikraft-web\\public\\images\\uploads\\" + gambar);
                dataTable[x][7] = icon;
                x++;
            }
            tblProducts.setModel(new DefaultTableModel(dataTable, header) {
                @Override
    ...
    private void set_id() {
        ...
        current_id = (String) tblProducts.getValueAt(row, 0);
//        System.out.println(current_id);
    ...
    private void initComponents() {
        ...
        tblProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nama", "Harga", "Satuan", "Stok", "Berat", "Gambar"
            }
        ) {
        ...
        tblProducts.setGridColor(new java.awt.Color(204, 204, 204));
        ...
        btnUpdate.setText("Manajemen Stok Produk");
        ...
        bg.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 240, -1, 30));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (current_id.equals("")) {
            JOptionPane.showMessageDialog(null, "Mohon pilih data produk yang ingin diubah");
        } else {
            StockProduct product = new StockProduct(current_id);
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            String reportPath = "D:\\Kuliah\\Kuliah\\Semester 4\\UAS\\ProyekAkhirUAS\\src\\main\\java\\com\\rayhanashlikh\\proyekakhiruas\\Report\\ProductsReport.jrxml";
